...
export function GlassAura() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      <div
        className="absolute left-[-8%] top-[12%] h-[60vh] w-[60vh] rounded-full blur-[55px] md:blur-[90px]"
        style={{ background: 'radial-gradient(circle, hsl(var(--primary) / 0.22), transparent 70%)' }}
      />
      <div
        className="absolute right-[-6%] top-[46%] h-[55vh] w-[55vh] rounded-full blur-[55px] md:blur-[90px]"
        style={{ background: 'radial-gradient(circle, hsl(var(--accent) / 0.20), transparent 70%)' }}
      />
      <div
        className="absolute bottom-[-10%] left-[35%] h-[50vh] w-[50vh] rounded-full blur-[55px] md:blur-[90px]"
